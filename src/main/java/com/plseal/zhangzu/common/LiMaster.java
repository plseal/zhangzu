...
public class LiMaster {
    public static List<String> make_ztype_list() {
		...
		z_type_list.add("功能胶（底胶）");
		z_type_list.add("功能胶（免洗钢化封层）");
		z_type_list.add("功能胶（防污镀晶封层）");
		z_type_list.add("功能胶（磨砂封层）");
		z_type_list.add("功能胶（俄式磨砂封层）");
		z_type_list.add("功能胶（加固胶）");
		z_type_list.add("功能胶（甲片粘合剂）");
		z_type_list.add("功能胶（粘钻胶）");
		z_type_list.add("功能胶（建构底胶）");
		...
		z_type_list.add("美甲工具（海绵搓条）");
		z_type_list.add("美甲工具（卸甲搓条）");
		z_type_list.add("美甲工具（打磨修型搓条）");
